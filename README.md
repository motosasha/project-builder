...
### Стили
Используйте <code>/_..._/</code> для автоматической замены части пути (пример: <code>../_img_/filename.jpg</code> будет заменен на <code>../img/filename.jpg</code>), если в переменной img лежит <code>/img/</code>.
